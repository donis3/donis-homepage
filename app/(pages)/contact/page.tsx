...
export const metadata: Metadata = {
	title: "Contact Me",
	description: "Get in touch with Deniz Özkan. Reach out for collaborations, job opportunities, or to discuss your next project.",
	keywords: "contact, full stack developer, hire developer, collaboration, job opportunities",
};
...
export default function ContactPage() {
	...
	return (
		<div className="bg-background text-foreground flex min-h-screen flex-1 flex-col items-center justify-center p-4 pt-(--navbar-height) pb-12">
			...
			/>
			<h1 className="mb-8 text-center text-4xl font-bold">Contact Deniz</h1>
