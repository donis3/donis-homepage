...
description: A mobile-first dart score keeping application built with Next.js App Router, featuring static export as an SPA. Supports 101x and ladder modes with local storage persistence using Zustand.
